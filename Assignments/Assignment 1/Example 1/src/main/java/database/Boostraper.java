...
public class Boostraper {
    ...
    private void bootstrapUserData() {
       // for (String schema : SCHEMAS) {
            System.out.println("Bootstrapping user data for " + Constants.Schemas.TEST);

            JDBConnectionWrapper connectionWrapper = new JDBConnectionWrapper(Constants.Schemas.TEST);
